...
|--------|----------|--------------------------|----------|-------|
| POST | /api/v1/holidays | 없음<br>**예시 1**<br>`POST /api/v1/holidays`<br>**예시 2**<br>`curl -X POST http://localhost:8080/api/v1/holidays` | json<br>{<br>&nbsp;&nbsp;"status": "success",<br>&nbsp;&nbsp;"years": [2020,2021,2022,2023,2024,2025],<br>&nbsp;&nbsp;"countriesCount": 110,<br>&nbsp;&nbsp;"totalHolidaysInserted": 15423<br>} | 최근 5년 공휴일 전체 로드 |
